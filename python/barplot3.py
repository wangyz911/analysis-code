...
n_groups = 5;
data = (0.03306,0.01412,0.02399,0.05832,0.03144)
#yr =np.array( [[0.03,0.08,0.26,0.02,0.04,0.09],
#      [0.03,0.09,0.26,0.02,0.05,0.08]])
yr = (0.00222,0.00035,0.00011,0.02103,0.00136)
...
plt.text(0.03306+0.015, 0-0.07,'3.99%',fontsize =14)
plt.text(0.01412+0.015, 1-0.07,'3.23%',fontsize =14)
plt.text(0.02399+0.015, 2-0.07,'10.26%',fontsize =14)
plt.text(0.05832+0.03, 3-0.07,'2.76%',fontsize =14)
plt.text(0.03144+0.015, 4-0.07,'4.10%',fontsize =14)
...
plt.figure(figsize=(8,6), dpi=300)
n_groups = 4;
data = (0.022,0.12022,0.00893,0.02823)
#yr =np.array( [[0.03,0.08,0.26,0.02,0.04,0.09],
#      [0.03,0.09,0.26,0.02,0.05,0.08]])
yr = (0.00077,0.0018,0.00003,0.00006)
...
plt.text(0.022+0.015, 0-0.07,'4.52%',fontsize =14)
plt.text(0.12022+0.015, 1-0.07,'22.36%',fontsize =14)
#plt.text(0.0126+0.015, 2-0.07,'4.43%',fontsize =14)
plt.text(0.00893+0.015, 2-0.07,'4.11%',fontsize =14)
plt.text(0.02823+0.015, 3-0.07,'11.33%',fontsize =14)
...
plt.figure(figsize=(8,6), dpi=300)
n_groups = 6;
data = (0.21449,0.06625,0.12946,0.04279,0.08595,0.01037)
#yr =np.array( [[0.03,0.08,0.26,0.02,0.04,0.09],
#      [0.03,0.09,0.26,0.02,0.05,0.08]])
yr = (0.00894,0.00950,0.00265,0.00489,0.01007,0.00104)
...
ax = plt.gca()
# 加上百分比标签
plt.text(0.21449+0.015, 0-0.07,'19.7%',fontsize =14)
plt.text(0.06625+0.015, 1-0.07,'2.43%',fontsize =14)
plt.text(0.12946+0.015, 2-0.07,'7.01%',fontsize =14)
plt.text(0.04279+0.015, 3-0.07,'2.00%',fontsize =14)
plt.text(0.08595+0.015, 4-0.07,'4.65%',fontsize =14)
plt.text(0.01037+0.015, 5-0.07,'0.94%',fontsize =14)
B=plt.plot(zero,x0,'--',color='k',linewidth=2)
#ax.set_title("△preference",fontsize=18)
ax.set_yticks(index + bar_width / 2)
