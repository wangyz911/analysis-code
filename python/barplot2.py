...
n_groups = 5;
data = (0.00024,0.04745,0.0301,0.07023,0.02255)
#yr =np.array( [[0.03,0.08,0.26,0.02,0.04,0.09],
#      [0.03,0.09,0.26,0.02,0.05,0.08]])
yr = (0.00388,0.00035,0.00015,0.02868,0.0025)
...
plt.text(0.00024+0.015, 0-0.07,'0.03%',fontsize =14)
plt.text(0.04745+0.015, 1-0.07,'10.85%',fontsize =14)
plt.text(0.0301+0.015, 2-0.07,'12.86%',fontsize =14)
plt.text(0.07023+0.03, 3-0.07,'3.32%',fontsize =14)
plt.text(0.02255+0.015, 4-0.07,'2.94%',fontsize =14)
...
plt.figure(figsize=(8,6), dpi=300)
n_groups = 5;
data = (0.0383,0.16233,0.0126,0.00797,0.02203)
#yr =np.array( [[0.03,0.08,0.26,0.02,0.04,0.09],
#      [0.03,0.09,0.26,0.02,0.05,0.08]])
yr = (00.00081,0.00227,0.0002,0.00005,0.00006)
...
plt.text(0.0383+0.015, 0-0.07,'7.87%',fontsize =14)
plt.text(0.16233+0.015, 1-0.07,'30.19%',fontsize =14)
plt.text(0.0126+0.015, 2-0.07,'4.43%',fontsize =14)
plt.text(0.00797+0.015, 3-0.07,'3.67%',fontsize =14)
plt.text(0.02203+0.015, 4-0.07,'8.84%',fontsize =14)
...
plt.figure(figsize=(8,6), dpi=300)
n_groups = 6;
data = (0.22214,0.06028,0.12952,0.04382,0.10501,0.00837)
#yr =np.array( [[0.03,0.08,0.26,0.02,0.04,0.09],
#      [0.03,0.09,0.26,0.02,0.05,0.08]])
yr = (0.00894,0.00970,0.00199,0.00416,0.00709,0.00131)
...
ax = plt.gca()
# 加上百分比标签
plt.text(0.22214+0.015, 0-0.07,'20.41%',fontsize =14)
plt.text(0.06028+0.015, 1-0.07,'2.21%',fontsize =14)
plt.text(0.12952+0.015, 2-0.07,'7.01%',fontsize =14)
plt.text(0.04382+0.015, 3-0.07,'2.04%',fontsize =14)
plt.text(0.10501+0.015, 4-0.07,'5.68%',fontsize =14)
plt.text(0.00837+0.015, 5-0.07,'0.76%',fontsize =14)
B=plt.plot(zero,x0,'--',color='k',linewidth=2)
#ax.set_title("△preference",fontsize=18)
ax.set_yticks(index + bar_width / 2)
