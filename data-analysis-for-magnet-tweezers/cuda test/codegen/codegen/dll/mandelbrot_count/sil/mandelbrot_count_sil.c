  ...
  if ((pIsXILApplicationStarted != NULL) && (*pIsXILApplicationStarted == 1)) {
    {
      if (pXILUtils) {
        ...
        const char * simulinkBlockPath =
          "E:\\analysis code\\data-analysis-for-magnet-tweezers\\cuda test\\codegen\\dll\\mandelbrot_count\\mandelbrot_count";
...
static boolean_T startAndSetupApplication()
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("mandelbrot_count");
...
void mandelbrot_count_xil_terminate()
{
