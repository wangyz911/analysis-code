...
## Generated on : Tue Dec 26 22:56:10 2017
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\mandelbrot_count.dll
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\mandelbrot_count.dll
...
INCLUDES_BUILDINFO = $(START_DIR)\codegen\dll\mandelbrot_count;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\codegen\dll\mandelbrot_count\mandelbrot_count_initialize.cu $(START_DIR)\codegen\dll\mandelbrot_count\mandelbrot_count_terminate.cu $(START_DIR)\codegen\dll\mandelbrot_count\mandelbrot_count.cu $(START_DIR)\codegen\dll\mandelbrot_count\rt_nonfinite.cu $(START_DIR)\codegen\dll\mandelbrot_count\rtGetNaN.cu $(START_DIR)\codegen\dll\mandelbrot_count\rtGetInf.cu
...
OBJS = mandelbrot_count_initialize.obj mandelbrot_count_terminate.obj mandelbrot_count.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
{$(START_DIR)\codegen\dll\mandelbrot_count}.cu.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"


{$(START_DIR)\codegen\dll\mandelbrot_count}.c.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"
...
{$(START_DIR)\codegen\dll\mandelbrot_count}.cpp.obj :
	$(CPP) $(CPPFLAGS) -o  "$@" "$<"
