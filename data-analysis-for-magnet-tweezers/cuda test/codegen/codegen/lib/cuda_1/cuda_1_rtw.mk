###########################################################################
## Makefile generated for MATLAB file/project 'cuda_1'. 
## 
## Makefile     : cuda_1_rtw.mk
## Generated on : Mon Jul 23 11:04:06 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\cuda_1.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\cuda_1.lib
...
INCLUDES_BUILDINFO = $(START_DIR)\codegen\lib\cuda_1;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -D MODEL=cuda_1 -D HAVESTDIO -D USE_RTMODEL
...
SRCS = $(START_DIR)\codegen\lib\cuda_1\cuda_1_initialize.cu $(START_DIR)\codegen\lib\cuda_1\cuda_1_terminate.cu $(START_DIR)\codegen\lib\cuda_1\cuda_1.cu $(START_DIR)\codegen\lib\cuda_1\rt_nonfinite.cu $(START_DIR)\codegen\lib\cuda_1\rtGetNaN.cu $(START_DIR)\codegen\lib\cuda_1\rtGetInf.cu
...
OBJS = cuda_1_initialize.obj cuda_1_terminate.obj cuda_1.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
{$(START_DIR)\codegen\lib\cuda_1}.cu.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"


{$(START_DIR)\codegen\lib\cuda_1}.c.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"
...
{$(START_DIR)\codegen\lib\cuda_1}.cpp.obj :
	$(CPP) $(CPPFLAGS) -o  "$@" "$<"
